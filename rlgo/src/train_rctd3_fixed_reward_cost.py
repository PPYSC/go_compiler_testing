...
#corpus_path = "/home/shareduser/ysc/go_compiler_testing/rlgo/src/data/data_71421_token_size_filtered.jsonl"
...
save_every_x_episodes = 500

check_point_prefix = "/home/shareduser/ysc/go_compiler_testing/rlgo/src/saved_model_test/rctd3_fixed_reward_cost_checkpoint"
...
current_time = datetime.datetime.now().strftime("%Y%m%d_%H%M%S")
checkpoint_path = check_point_prefix + f"_{current_time}_episodes_{total_episodes}_final.bin"
with open(checkpoint_path, 'wb') as f:
    pickle.dump(rctd3_agent, f)
print("+"*50)
print(f"Checkpoint saved:\n{checkpoint_path}\n")
