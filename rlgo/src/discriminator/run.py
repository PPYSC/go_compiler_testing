...
class Pipeline:
    ...
    def generate_block_seqs(self):
        ...
        word2vec = Word2Vec.load('discriminator/embedding/node_w2v_128').wv # 直接加载，需要保证文件存在于当前路径下
...
class Cluster:
    ...
    def cluster(cls,program_string=None):
        ...
        model.load_state_dict(torch.load('discriminator/saved_model/best_model.bin'))  # 保证存在路径
